...
import SelectMapPositions from './pages/CreateOrphanage/SelectMapPositions';
    ...
    return (
        <NavigationContainer>
            <Navigator screenOptions={{ headerShown: false, cardStyle: { backgroundColor: '#f2f3f5' } }}>
                ...
                <Screen name="SelectMapaPositions" component={SelectMapPositions} options={{headerShown: true, header: ()=> <Header title="Selecione no mapa" />}} />
